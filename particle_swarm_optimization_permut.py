...
class Particle:
    ...
    def update_position(self, pos_best_local):
        ...
        personal_mask = [True if personal_start_index < x < personal_start_index + self.personal_section else False for
                         x in range(len(self.pos_best_indiv))]
        cognitive_mask = [True if cognitive_start_index < x < cognitive_start_index + self.cognitive_section else False
                          for x in range(len(self.pos_best_indiv))]
        social_mask = [True if social_start_index < x < social_start_index + self.social_section else False for x in
                       range(len(self.pos_best_indiv))]
